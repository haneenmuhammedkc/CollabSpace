...
import { 
  IconUsers, IconCommunities, IconProjects, IconTeams, IconTrendingUp, IconTrendingDown 
} from './Icons';
    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 mb-8">
        {[
          ...
          { title: 'Projects Posted', value: '8,901', icon: <IconProjects />, growth: '+18.1%', pos: true },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white rounded-xl p-6 shadow-sm border border-slate-200">
          ...
          <div className="h-[250px] flex items-end gap-3 sm:gap-6 pb-6 pl-8 border-b border-l border-slate-200 relative mt-4">
            ...
            {[45, 60, 30, 80, 55, 90].map((h, i) => (
              <div className="flex-1 flex items-end justify-center gap-1 sm:gap-2 h-full relative group" key={i}>
                <div className="w-full max-w-[24px] bg-blue-600 rounded-t-sm transition-all duration-300 group-hover:brightness-110" style={{ height: `${h}%` }}></div>
                <div className="w-full max-w-[24px] bg-sky-300 rounded-t-sm transition-all duration-300 group-hover:brightness-110" style={{ height: `${h * 0.7}%` }}></div>
              </div>
            ))}
          </div>
        </div>
