            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  {/* Github Link */}
                  {user?.github && (
                  <a href={formatLink(user.github)} target="_blank" rel="noopener noreferrer"
                    className="flex items-center gap-3 text-slate-600 hover:text-[#89A8B2] font-medium transition group">
                    <svg className="w-5 h-5 text-[#B3C8CF] group-hover:text-[#89A8B2] transition"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  {/* Website Link */}
                  {user?.website && (
                  <a href={formatLink(user.website)} target="_blank" rel="noopener noreferrer"
                    className="flex items-center gap-3 text-slate-600 hover:text-[#89A8B2] font-medium transition group">
                    <svg className="w-5 h-5 text-[#B3C8CF] group-hover:text-[#89A8B2] transition" fill="none"
                  ...
                  {/* Linkedin Link */}
                  {user?.linkedin && (
                  <a href={formatLink(user.linkedin)} target="_blank" rel="noopener noreferrer"
                    className="flex items-center gap-3 text-slate-600 hover:text-[#89A8B2] font-medium transition group">
                    <svg className="w-5 h-5 text-[#B3C8CF] group-hover:text-[#89A8B2] transition" fill="none"
                      stroke="currentColor" viewBox="0 0 24 24">
                      <path
